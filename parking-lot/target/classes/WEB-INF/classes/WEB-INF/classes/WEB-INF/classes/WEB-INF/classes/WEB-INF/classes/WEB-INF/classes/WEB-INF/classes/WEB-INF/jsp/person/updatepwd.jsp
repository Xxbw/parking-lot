				...
				<div class="tpl-portlet-components">
					...
					<div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
							<br> <br> <br>
                            <form class="am-form am-form-horizontal" id="f1" action="${pageContext.request.contextPath}/admin/doUpdate" method="post" >
								<input type="hidden" name="id" value="${sessionScope.user.id}"/>
								<input type="hidden" name="userName" value="${sessionScope.user.userName}"/>
                                <div class="am-form-group">
                                    <label  class="am-u-sm-3 am-form-label">原始密码</label>
                                    <div class="am-u-sm-9">
                                        <input type="password" id="paw1" name="oldpwd"/>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="password" id="paw" name="newpwd"/>
                                    </div>
                                </div>     
