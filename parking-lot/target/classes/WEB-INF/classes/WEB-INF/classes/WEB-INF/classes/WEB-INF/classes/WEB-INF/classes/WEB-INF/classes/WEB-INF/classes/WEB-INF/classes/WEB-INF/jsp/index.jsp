...
// });
  ...
  function s1(){
   ...
   function s2(){
        ...
        var phoneValue = $("#tele").val();
        var phoneReg = /^1[3456789]\d{9}$/;
        if(!phoneReg.test(phoneValue)){
            $(".errorMsg1").text("手机号输入不合法！");
            $("#tele").val("")
            return false;
        }
       ...
       clicks2(usernameValue1,passwordValue1,phoneValue,emailValue);
    }
   function clicks2(userName,password,phone,email){
      var user = {
          "userName":userName,
          "password":password,
          "phone":phone,
...
<script src="${pageContext.request.contextPath}/statics/js/chroma.min.js"></script>
<script src="${pageContext.request.contextPath}/statics/js/dat.gui.min.js"></script>
...
<div class="content">
    <div class="form sign-in">
        <h2>欢迎回来</h2>
        <form action="${pageContext.request.contextPath }/admin/doLogin" method="post" id="f1">
        <label>
            <span>账号</span>
            <input type="text" value="${sessionScope.registerUser.userName}" id="username" name="userName"/>
        </label>
        <label>
            <span>密码</span>
            <input type="password" value="${sessionScope.registerUser.password}" id="password" name="password"/>
        </label>
<%--        <label>--%>
<%--            <span>验证码</span>--%>
...
<%--        </label>--%>
    ...
    <div class="sub-cont">
        ...
        <div class="form sign-up">
            <h2>立即注册</h2>
         <form action="${pageContext.request.contextPath }/admin/register" method="post" id="f2">
            ...
            <label>
                <span id="errorMsg1" style="font-size: 8px;color: red"></span>
                <span class="errorMsg1" style="font-size: 8px;color: red"><%=request.getAttribute("mgs1")==null?"":request.getAttribute("mgs1")%></span>
            </label>
              <button type="button" style="margin-top: 30px;" class="submit" id="sbtn" onclick="s2()">注 册</button>
            </form>
        </div>
    </div>
</div>
