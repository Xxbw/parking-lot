...
<head>
    ...
    <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/statics/assets/i/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath}/statics/assets/i/app-icon72x72@2x.png">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/statics/assets/css/amazeui.min.css" />
            ...
            <div class="tpl-block">
                ...
                <div class="am-g tpl-amazeui-form">
                    <div class="am-u-sm-12 am-u-md-9">
                        <br> <br> <br>
                        <form class="am-form am-form-horizontal"  id="f1" action="${pageContext.request.contextPath}/admin/updateInfo" method="post" >
                            <input type="hidden" name="id" value="${sessionScope.user.id}"/>
                            <input type="hidden" name="id" value="${sessionScope.user.userName}"/>
                            <input type="hidden" name="id" value="${sessionScope.user.userName}"/>
...
<%--                            <input type="hidden" name="paw" value="${user.paw}">--%>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="tele" name="phone" value="${sessionScope.user.phone}"/>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label  class="am-u-sm-3 am-form-label" >邮箱(选填)</label>
                                <div class="am-u-sm-9">
