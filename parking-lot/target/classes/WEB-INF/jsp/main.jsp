...
<head>
    ...
    <script src="${pageContext.request.contextPath}/statics/js/test.js" type="text/javascript"  charset="UTF-8" ></script>
    <script src="${pageContext.request.contextPath}/statics/js/common.js" type="text/javascript"  charset="UTF-8"></script>
    <script src="${pageContext.request.contextPath}/statics/js/config.js" type="text/javascript"  charset="UTF-8"></script>
            ...
            <div class="tpl-block" >
                <div class="am-g">
                    <div class="am-u-sm-12">
                        <h1 style="text-align:center;color: #5b9bd1;">欢迎使用后台管理系统</h1>
                    </div>
                </div>
            </div>
        </div>
